...
namespace VSX.UniversalVehicleCombat.Loadout
{
    ...
    /// </summary>
    public class LoudoutUIControllerTuto : MonoBehaviour
    {
        ...
        */
        ...
        {
            loadoutManager.CycleModule(forward);
        }


        public virtual void CycleModuleMountSelection(bool forward)
        {
            loadoutManager.CycleModuleMount(forward);
        }
        ...
        protected virtual void UpdateSlotsUI()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < loadoutManager.LoadoutData.Slots.Count; ++i)
                {
                    ...
                    {
                        slotButtonsListController.ButtonControllers[i].SetImage(0, loadoutManager.Items.vehicles[loadoutManager.LoadoutData.Slots[i].selectedVehicleIndex].sprites[slotIconSpriteIndex]);
                    ...
                    {
                        slotButtonsListController.ButtonControllers[i].SetImage(0, slotEmptyIcon);
        ...
        protected virtual void UpdateModuleSelectionUI()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < loadoutManager.SelectableModuleIndexes.Count; ++i)
                {
                    ...
                    moduleButtonsListController.ButtonControllers[i].SetImage(0, moduleItem.sprites.Count > 0 ? moduleItem.sprites[0] : null);
        ...
        {
            loadoutManager.ClearSelectedModuleMount();
        }
