...
namespace VSX.Utilities
{
    ...
    public class LinkableVariable
    {
        ...
        /// </summary>
        public void InitializeLinkDelegate(out string errorMessage)
        {
            errorMessage = "";
            ...
            if (methodInfo == null)
            {
                errorMessage = "Linkable variable with key " + key + " is set as a Linked Variable but has no function assigned. Assign a function to this linked variable in the inspector.";
                return;
            }
