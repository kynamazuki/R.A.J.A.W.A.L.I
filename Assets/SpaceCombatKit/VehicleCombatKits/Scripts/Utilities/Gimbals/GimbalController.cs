...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class GimbalController : MonoBehaviour
    {
        ...
        public float MinHorizontalPivotAngle
        {
            get { return minHorizontalPivotAngle; }
            set { minHorizontalPivotAngle = value; }
        }

        [SerializeField]
        protected float maxHorizontalPivotAngle = 180;
        public float MaxHorizontalPivotAngle
        {
            get { return maxHorizontalPivotAngle; }
            set { maxHorizontalPivotAngle = value; }
        }
        ...
        public float MinVerticalPivotAngle
        {
            get { return minVerticalPivotAngle; }
            set { minVerticalPivotAngle = value; }
        }

        // The maximum angle for the vertical pivot
        [SerializeField]
        protected float maxVerticalPivotAngle = 90f;
        public float MaxVerticalPivotAngle
        {
            get { return maxVerticalPivotAngle; }
            set { maxVerticalPivotAngle = value; }
        }
        ...
        public float MaxHorizontalAngularVelocity
        {
            get { return maxHorizontalAngularVelocity; }
            set { maxHorizontalAngularVelocity = value; }
        }

        [SerializeField]
        protected float maxVerticalAngularVelocity = 3f;
        public float MaxVerticalAngularVelocity
        {
            get { return maxVerticalAngularVelocity; }
            set { maxVerticalAngularVelocity = value; }
        }
        ...
        public virtual float AngleToTarget(Vector3 targetPosition)
        {
            return (Vector3.Angle(verticalPivot.forward, targetPosition - verticalPivot.position));
        }
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (horizontalPivot != null)
            {
                ...
                UnityEditor.Handles.DrawSolidArc(verticalPivot != null ? verticalPivot.position : horizontalPivot.position, horizontalPivot.up, startVecH, maxHorizontalPivotAngle - minHorizontalPivotAngle, arcRadius);
            }
