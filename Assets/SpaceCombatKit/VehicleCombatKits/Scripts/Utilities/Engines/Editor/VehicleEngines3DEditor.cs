...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class VehicleEngines3DEditor : Editor
    {
        ...
        protected SerializedProperty steeringModulatorsProperty;
        protected SerializedProperty movementModulatorsProperty;
        protected SerializedProperty boostModulatorsProperty;
        ...
        private void OnEnable()
        {
            ...
            steeringModulatorsProperty = serializedObject.FindProperty("steeringModulators");
            movementModulatorsProperty = serializedObject.FindProperty("movementModulators");
            boostModulatorsProperty = serializedObject.FindProperty("boostModulators");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(steeringModulatorsProperty);
            EditorGUILayout.PropertyField(movementModulatorsProperty);
            EditorGUILayout.PropertyField(boostModulatorsProperty);
