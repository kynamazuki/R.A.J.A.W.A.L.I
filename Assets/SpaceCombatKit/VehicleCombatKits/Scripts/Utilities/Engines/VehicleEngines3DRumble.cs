...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class VehicleEngines3DRumble : MonoBehaviour
    {
        ...
        protected virtual void BoostRumblesUpdate()
        {
            ...
            if (engines.ModulatedBoostInputs.magnitude > 0) RumbleManager.Instance.AddSingleFrameRumble(Mathf.Clamp(engines.ModulatedBoostInputs.magnitude, 0, 1) * maxBoostRumble, engines.transform.position);
        }
