...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class GameAgent : MonoBehaviour 
	{
        ...
        [Tooltip("A list of sprites used to display the agent.")]
        [SerializeField]
        ...
        protected virtual void OnDestroy()
        {
            ...
            {
                if (GameAgentManager.Instance != null) GameAgentManager.Instance.Unregister(this);
            }
        }
        ...
        public virtual void EnterVehicle(Vehicle newVehicle)
		{
            ...
            if (newVehicle != null && newVehicle == character)
            {
