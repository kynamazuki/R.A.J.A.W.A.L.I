...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class GameAgentManager : MonoBehaviour 
	{
        ...
        [SerializeField]
        protected bool useFirstPlayerInScene = true;
        ...
        public UnityAction<GameAgent> onGameAgentRegistered;
        public UnityAction<GameAgent> onGameAgentDied;


        protected virtual void Reset()
        {
            // Get the first player in the scene
            GameAgent[] gameAgents = FindObjectsOfType<GameAgent>();
        ...
        {
            if (startingFocusedGameAgent == null && useFirstPlayerInScene)
            {
                GameAgent[] gameAgents = FindObjectsOfType<GameAgent>();
                foreach (GameAgent gameAgent in gameAgents)
                {
        ...
        public virtual void Register(GameAgent newAgent, bool focusThisAgent = false)
		{
            ...
            newAgent.onDied.AddListener(() => { OnGameAgentDied(newAgent); });

            if (onGameAgentRegistered != null) onGameAgentRegistered.Invoke(newAgent);
        ...
        public virtual void SetFocusedGameAgent(GameAgent newFocusedGameAgent)
		{
            if (this.focusedGameAgent != null)
            {
                ...
                this.focusedGameAgent.onExitedVehicle.RemoveListener(OnFocusedVehicleChanged);
            ...
            if (focusedGameAgent != null)
            {
                ...
                focusedGameAgent.onExitedVehicle.AddListener(OnFocusedVehicleChanged);
            ...
            onFocusedVehicleChanged.Invoke(focusedGameAgent == null ? null : focusedGameAgent.Vehicle);
		}
        ...
        protected virtual void OnGameAgentDied(GameAgent agent)
        {
            if (onGameAgentDied != null) onGameAgentDied.Invoke(agent);
        }
    }
}
