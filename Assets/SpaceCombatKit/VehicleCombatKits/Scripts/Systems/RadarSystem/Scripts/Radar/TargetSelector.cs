...
namespace VSX.UniversalVehicleCombat.Radar
{
    ...
    public class TargetSelector : MonoBehaviour
    {
        ...
        [Tooltip("Whether to switch to the front most target when looking for a new one, e.g. if the current one is destroyed.")]
        [SerializeField]
        protected bool defaultToFrontMostTarget = true;


        [Tooltip("The angle within which to look for targets in front.")]
        [SerializeField]
