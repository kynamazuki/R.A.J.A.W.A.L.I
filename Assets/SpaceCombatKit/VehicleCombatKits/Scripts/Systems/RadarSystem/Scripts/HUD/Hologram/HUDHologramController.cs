    ...
    public class HUDHologramController : HUDComponent
    {
        ...
        public void SetHologram(Hologram hologram)
        {
            if (this.hologram != null)
            {
                ...
                this.hologram.transform.SetParent(this.hologram.OriginalParent);
                this.hologram = null;
            }
            ...
            hologram.SetLayer(hologramParent.gameObject.layer);
        ...
        {
            if (updateOrientation && hologram != null && orientationTarget != null)
            {
