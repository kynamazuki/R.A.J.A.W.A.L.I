            ...
            switch (turretState)
            {
                ...
                case TurretState.Acquiring:
                    ...
                    else
                    {
                        ...
                        if (AngleToTarget() < minFiringAngle && weapon.FiringConditions.ConditionsMet)
                        {
                ...
                case TurretState.Engaged:
                    ...
                    {
                        if (trackTargetWhenEngaged) UpdateTargetPosition();
                ...
                case TurretState.Standby:
                    ...
                    { 
                        ...
                        {
                            if (trackTargetWhenOnStandby) UpdateTargetPosition();
