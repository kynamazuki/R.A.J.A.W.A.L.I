...
namespace VSX.UniversalVehicleCombat
{
	...
	public class MountedTriggerable 
	{
		...
		public MountedTriggerable(Triggerable triggerable, Turret turret = null)
		{
	...
	public class TriggerablesManager : ModuleManager
	{
        ...
        [SerializeField]
        protected List<Condition> triggeringConditions = new List<Condition>();
        ...
        protected virtual void CreateMountedTriggerable(Triggerable triggerable)
        {
            ...
            MountedTriggerable newMountedTriggerable = new MountedTriggerable(triggerable, triggerable.GetComponent<Turret>());
        ...
        public void StartTriggeringAtIndex(int triggerIndex)
		{
            ...
            if (!fireSequentially)
            {
                ...
                for (int i = 0; i < mountedTriggerables.Count; ++i)
                {
                    if (mountedTriggerables[i].turret != null && mountedTriggerables[i].turret.TurretMode != TurretMode.Manual) continue;
