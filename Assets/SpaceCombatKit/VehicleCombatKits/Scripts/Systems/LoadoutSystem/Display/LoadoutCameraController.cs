...
namespace VSX.UniversalVehicleCombat.Loadout
{
	...
	public class LoadoutCameraController : MonoBehaviour
    {
        ...
        [SerializeField]
        protected bool rotateCameraAroundVehicleBoundsCenter = true;
        ...
        protected virtual void Reset()
        {
            ...
            loadoutUIController = FindAnyObjectByType<LoadoutUIController>();
        ...
        protected virtual void VehicleFocusUpdate()
        {
            ...
            if (rotateCameraAroundVehicleBoundsCenter)
            {
                viewRotationGimbal.transform.position = vehicle.transform.TransformPoint(vehicle.Bounds.center);
            }
        ...
        protected virtual Vector3 ViewportPositionAdjustment(float distance, Vector2 viewportPosition)
        {
            ...
            // Calculate the half dimensions of the viewport in world coordinates at the specified distance
